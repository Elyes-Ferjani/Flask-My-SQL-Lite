...
app.config['MYSQL_DATABASE_HOST'] = '##INSERT_THE_DB_ENDPOINT##'
app.config['MYSQL_DATABASE_USER'] = '##INSERT_DB_USER##'
app.config['MYSQL_DATABASE_PASSWORD'] = '##INSERT_THE_USER_PASSWORD##'
app.config['MYSQL_DATABASE_DB'] = '##INSERT_DB##'
